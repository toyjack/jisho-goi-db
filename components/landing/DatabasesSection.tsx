...
function DatabasesSection() {
  ...
  return (
    <div className="hero bg-base-100 min-h-screen mx-auto max-w-full">
      ...
      <div className="flex flex-row gap-3">
        {
          datasets.map((dataset) => {
            return (
              <div className="card card-compact w-full bg-base-100 shadow-xl" key={dataset.title}>
                <figure>
